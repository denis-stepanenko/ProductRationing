...
{
    public partial class ProductsAndBigOperationsWithPZVPage : Page
    {
        private Product _product;

        private readonly ProductOperationRepo _repo = new ProductOperationRepo();

        public ProductsAndBigOperationsWithPZVPage()
        {
            InitializeComponent();
        }
        ...
        private void ShowButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            reportViewer.Reset();
            reportViewer.LocalReport.ReportEmbeddedResource = "ProductRationing.Reports.ProductsAndBigOperationsWithPZV.rdlc";
