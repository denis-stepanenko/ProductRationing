...
namespace ProductRationing.Reports.Pages
{
    public partial class SumByGroupsPage : Page
    {
        ...
        private void ShowButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            reportViewer.Reset();
            reportViewer.LocalReport.ReportEmbeddedResource = "ProductRationing.Reports.SumByGroups.rdlc";
