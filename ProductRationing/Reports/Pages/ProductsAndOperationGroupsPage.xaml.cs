...
{
    public partial class ProductsAndOperationGroupsPage : Page
    {
        private Product _product;

        private readonly ProductOperationRepo _repo = new ProductOperationRepo();

        public ProductsAndOperationGroupsPage()
        {
            InitializeComponent();
        }
        ...
        private void ShowButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            reportViewer.Reset();
            reportViewer.LocalReport.ReportEmbeddedResource = "ProductRationing.Reports.ProductsAndOperationGroups.rdlc";
