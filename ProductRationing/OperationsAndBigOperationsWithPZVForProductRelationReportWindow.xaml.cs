...
{
    public partial class OperationsAndBigOperationsWithPZVForProductRelationReportWindow : Window
    {
        private readonly ProductOperationRepo _repo = new ProductOperationRepo();

        public OperationsAndBigOperationsWithPZVForProductRelationReportWindow(ProductEntry product)
        {
            InitializeComponent();
